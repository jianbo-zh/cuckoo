...
func (x *DepositMessage) GetFromPeerId() string {
	if x != nil {
		return x.FromPeerId
	}
	return ""
...
func (x *DepositMessage) GetToPeerId() string {
	if x != nil {
		return x.ToPeerId
	}
	return ""
...
var file_pb_message_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x6f, 0x50, 0x65, 0x65, 0x72, 0x49,
