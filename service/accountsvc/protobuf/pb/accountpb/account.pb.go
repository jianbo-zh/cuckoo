...
type Account struct {
	...
	AutoDepositMessage bool   `protobuf:"varint,6,opt,name=autoDepositMessage,proto3" json:"autoDepositMessage,omitempty"` // 自动发送寄存消息
	DepositAddress     []byte `protobuf:"bytes,7,opt,name=depositAddress,proto3" json:"depositAddress,omitempty"`          // 设置消息寄存地址(peerID)
}
...
func (x *AccountPeer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountPeer) ProtoMessage() {}

func (x *AccountPeer) ProtoReflect() protoreflect.Message {
	mi := &file_proto_account_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccountPeer.ProtoReflect.Descriptor instead.
func (*AccountPeer) Descriptor() ([]byte, []int) {
	return file_proto_account_proto_rawDescGZIP(), []int{1}
}

func (x *AccountPeer) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *AccountPeer) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AccountPeer) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *AccountPeer) GetDepositAddress() []byte {
	if x != nil {
		return x.DepositAddress
	}
	return nil
...
func (x *AccountOnline) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountOnline) ProtoMessage() {}

func (x *AccountOnline) ProtoReflect() protoreflect.Message {
	mi := &file_proto_account_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccountOnline.ProtoReflect.Descriptor instead.
func (*AccountOnline) Descriptor() ([]byte, []int) {
	return file_proto_account_proto_rawDescGZIP(), []int{2}
}

func (x *AccountOnline) GetIsOnline() bool {
	if x != nil {
		return x.IsOnline
	}
	return false
...
var file_proto_account_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x70,
	0x62, 0x22, 0xeb, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x69, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0e, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22,
	0x71, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x65, 0x65, 0x72, 0x12, 0x0e,
	...
	0x28, 0x0c, 0x52, 0x0e, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x22, 0x2b, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4f, 0x6e, 0x6c,
	0x69, 0x6e, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x73, 0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x62,
...
var file_proto_account_proto_goTypes = []interface{}{
	...
	(*AccountPeer)(nil),   // 1: account.pb.AccountPeer
	(*AccountOnline)(nil), // 2: account.pb.AccountOnline
}
