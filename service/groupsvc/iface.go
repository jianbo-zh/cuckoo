...
type GroupServiceIface interface {
	...
	GetGroupMemberIDs(ctx context.Context, groupID string) ([]peer.ID, error)       // 成员IDs
	GetGroupOnlineMemberIDs(ctx context.Context, groupID string) ([]peer.ID, error) // 成员IDs(在线)
