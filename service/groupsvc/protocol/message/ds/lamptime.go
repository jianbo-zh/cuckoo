...
func (m *MessageDs) GetLamportTime(ctx context.Context, groupID GroupID) (uint64, error) {
...
func (m *MessageDs) TickLamportTime(ctx context.Context, groupID GroupID) (uint64, error) {
	m.messageLamportMutex.Lock()
	defer m.messageLamportMutex.Unlock()
...
func (m *MessageDs) MergeLamportTime(ctx context.Context, groupID GroupID, lamptime uint64) error {
	m.messageLamportMutex.Lock()
	defer m.messageLamportMutex.Unlock()
