...
func (m *MessageProto) getMessageSummary(groupID string) (*pb.DataSummary, error) {
...
func (m *MessageProto) getRangeMessages(groupID string, startID string, endID string) ([]*pb.Message, error) {
...
func (m *MessageProto) getMessagesByIDs(groupID string, msgIDs []string) ([]*pb.Message, error) {
