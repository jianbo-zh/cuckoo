...
func (a *AdminService) sync(groupID string, peerID peer.ID) {
...
func (a *AdminService) loopSync(groupID string, stream network.Stream, rd pbio.ReadCloser, wt pbio.WriteCloser) error {
...
func (a *AdminService) handleSyncSummary(groupID string, syncmsg *pb.SyncLog, wt pbio.WriteCloser) error {
...
func (a *AdminService) handleSyncRangeHash(groupID string, syncmsg *pb.SyncLog, wt pbio.WriteCloser) error {
...
func (a *AdminService) handleSyncRangeIDs(groupID string, syncmsg *pb.SyncLog, wt pbio.WriteCloser) error {
...
func (a *AdminService) handleSyncPushMsg(groupID string, syncmsg *pb.SyncLog) error {
	var msg pb.Log
...
func (a *AdminService) handleSyncPullMsg(groupID string, syncmsg *pb.SyncLog, wt pbio.WriteCloser) error {
...
func (a *AdminService) getMessageSummary(groupID string) (*pb.DataSummary, error) {
...
func (a *AdminService) getRangeMessages(groupID string, startID string, endID string) ([]*pb.Log, error) {
	return a.data.GetRangeMessages(groupID, startID, endID)
}

func (a *AdminService) rangeHash(groupID string, startID string, endID string) ([]byte, error) {
...
func (a *AdminService) getRangeIDs(groupID string, startID string, endID string) (*pb.DataRangeIDs, error) {
	ids, err := a.data.GetRangeIDs(groupID, startID, endID)
	if err != nil {
		return nil, err
	}
...
func (a *AdminService) getMessagesByIDs(groupID string, msgIDs []string) ([]*pb.Log, error) {
