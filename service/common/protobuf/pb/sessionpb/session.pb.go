...
func (x *SessionLastMessage) Reset() {
	*x = SessionLastMessage{}
...
func (x *SessionLastMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionLastMessage) ProtoMessage() {}

func (x *SessionLastMessage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_session_proto_msgTypes[0]
...
// Deprecated: Use SessionLastMessage.ProtoReflect.Descriptor instead.
func (*SessionLastMessage) Descriptor() ([]byte, []int) {
	return file_proto_session_proto_rawDescGZIP(), []int{0}
}

func (x *SessionLastMessage) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *SessionLastMessage) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
var file_proto_session_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x70,
	0x62, 0x22, 0x4a, 0x0a, 0x12, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4c, 0x61, 0x73, 0x74,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x62, 0x06, 0x70,
...
var file_proto_session_proto_goTypes = []interface{}{
	(*SessionLastMessage)(nil), // 0: session.pb.SessionLastMessage
}
...
func file_proto_session_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_session_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SessionLastMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
